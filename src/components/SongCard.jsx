...
const SongCard = ({song, isPlaying, activeSong, i, data}) => {
  ...
  return (
    <div className="flex flex-col w-[245px] p-4 bg-white/5 bg-opacity-80 backdrop-blur-sm animate-slideup
    rounded-lg cursor-pointer ">
      <div className="relative w-full h-58 group">
        ...
        <img className="rounded-lg" src={song?.song_art_image_url} alt="img" />
      </div>
